    ...
    return <div >
        ...
        <div className='allprojects'>
            <div className='project'>
                <img src={require('../images/Capstone.png')} alt='proimg'/>
            ...
            <div className='project'>
                <img src={require('../images/jobbyjob.png')} alt='proimg'/>
            ...
            <div className='project'>
                <img src={require('../images/pthree.png')} alt='proimg'/>
            ...
            <div className='project'>
                <img src={require('../images/pone.png')} alt='proimg'/>
